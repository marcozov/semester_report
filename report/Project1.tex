...
%In theory it would be logical to consider only the former value of M.
...
\end{subfigure}
%\caption{Data fusion with packet losses simulation. M=N/3+1}
\label{fig:fig}
\end{figure}
\section{Conclusion}
...
\bibitem{IEEEhowto:kopka}
\label{reference10}
L. Lamport (November 10, 2009). \emph{Paxos Made Simple}. November, 2001.
